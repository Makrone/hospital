...
<head>
<meta charset="UTF-8">
<title>Edit medical service</title>
			...
			<div class="container">
				<div class="col-lg-6 align-justify-center pr-4 pl-0 contact-form">
					<div class="">
						...
						<h6 class="subtitle font-weight-normal">Please edit medical
							Service</h6>
						<form class="mt-3">
							<div class="row">
								<div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<input class="form-control" type="text"
											value="${medicalService.description}" id="description"
								...
								<div class="col-lg-12">
									<div class="footer">
										<input class="form-control" type="hidden" name="action"
											value="update-medical-service" /> <input type="hidden"
											name="id" value="${medicalService.id}" />
										<div class="btnfirst">
											<button
												class="btn btn-md btn-block btn-danger-gradiant text-white border-0"
												type="submit" name="registration">Update</button>
										</div>
									</div>
								</div>
							</div>
