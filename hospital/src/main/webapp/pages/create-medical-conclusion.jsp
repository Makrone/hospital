		...
		<div class="row">
			<div class="container">
				<div class="col-lg-6 align-justify-center pr-4 pl-0 contact-form">
					<div class="">
						<h2 class="mb-3 font-weight-light">Create new Medical
							Conclusion</h2>
						...
						<form class="mt-3">
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<textarea cols="52" rows="5" id="medical_conclusion" required
								...
								<div class="col-lg-12">
									<div class="footer">
										<input type="hidden" name="action"
											value="save-medical-conclusion" /> <input type="hidden"
											name="treatmentId" value="${treatmentId}" />
										<div class="btnfirst">
											<button
												class="btn btn-md btn-block btn-danger-gradiant text-white border-0"
												type="submit" name="medicament">Create</button>
										</div>
									</div>
								</div>
							</div>
