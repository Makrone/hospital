						...
						<div class="col-sm-8">
							<div class="card-block">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<p class="text-info m-b-10 f-w-600">Created</p>
										<h6 class="text-black f-w-400">${user.created}</h6>
									</div>
									<div class="col-sm-6">
										<p class="text-info m-b-10 f-w-600">Money</p>
										<h6 class="text-black f-w-400">${user.money}</h6>
									</div>
								</div>
									...
									<div class="btn-group" role="group" aria-label="Basic example">
										<form class="navbar-form pull-right" action="main"
											...
											<input type="hidden" name="action"
												value="show-service-client" />
											<button class="btn btn-outline-info btn-sm mb-2 mr-1" type="submit">
										...
										<form class="navbar-form pull-right" action="main"
											method="POST">
											<input type="hidden" name="action"
												value="show-client-doctors" />
											<div class="btnfirst">
												<button class="btn btn-outline-info btn-sm mb-2 mr-1" type="submit">Make
										...
										<form class="navbar-form pull-right" action="main"
											method="POST">
											<input type="hidden" name="action"
												value="show-client-treatments" /> <input type="hidden"
												name="clientId" value="${user.id}" />
											<button class="btn btn-outline-info btn-sm mb-2 mr-1" type="submit">
				...
				<div class="row mt-3">
					...
					<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
						...
						<p>For almost 30 years of activity, the centers have received
							...
							and recognition. "MRC" is among the most famous medical centers
							in the Republic of Belarus.</p>
					</div>
					<!-- Grid column -->
