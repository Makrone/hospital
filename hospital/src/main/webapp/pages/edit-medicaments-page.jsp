			...
			<div class="container">
				<div class="col-lg-6 align-justify-center pr-4 pl-0 contact-form">
					<div class="">
						...
						<h6 class="subtitle font-weight-normal">Please edit
							medicament</h6>
						<form class="mt-3">
							<div class="row">
								<div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="form-group">
										<input class="form-control" type="text"
											value="${medicamentService.description}" id="description"
								...
								<div class="col-lg-12">
									<div class="footer">
										<input type="hidden" name="action" value="update-medicament" />
										<input type="hidden" name="id" value="${medicamentService.id}" />
										<div class="btnfirst">
											<button
