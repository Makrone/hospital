		...
		<div class="row">
			<div class="container">
				<div class="col-lg-6 align-justify-center pr-4 pl-0 contact-form">
					<div class="">
						<h2 class="mb-3 font-weight-light">Create new Treatment</h2>
								...
								<div class="col-lg-12">
									<div class="form-group">
										<div class="control-group">
											<div class="form-control"> ${doctor.firstName} ${doctor.lastName}</div>
										</div>
									...
									<div class="footer">
										...
										<div class="btnfirst">
											<button
												...
												type="submit" name="registration">Submit</button>
										</div>
									</div>
								</div>
							</div>
