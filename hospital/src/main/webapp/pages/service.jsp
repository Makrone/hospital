		...
		<c:forEach var="service" items="${services}">
			<div class="border-bottom border-info">
				<div class="row">
					...
					<div class="col-md-3">
						<form class="navbar-form pull-right" action="main" method="POST">
							<input type="hidden" name="action" value="delete-service" /> <input
								type="hidden" name="serviceId" value="${service.id}" />
							<button class="btn btn-outline-danger btn-sm mb-2 mr-1" type="submit">
						...
						<form class="navbar-form pull-right" action="main" method="POST">
							...
							<button class="btn btn-outline-primary btn-sm mb-2 mr-1" type="submit">
